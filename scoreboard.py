...
class Scoreboard:
    ...
    def prepare_high_score(self):
        ...
        self.high_score_rect.top = self.level_rect.bottom + 1

    def prepare_max_score(self):
        self.max_score_image = self.font.render(
            f"{self.stats.max_score:,}", True, self.text_color, self.settings.bg_color
        )
        self.max_score_rect = self.max_score_image.get_rect()
        self.max_score_rect.right = self.screen_rect.right - 20
